...
try:    
    ...
    print(f'La clave 004 no está en el diccionario.') 
...
def validar_clave(diccionario, clave):
    try:
        ...
        print('La clave 004 no está en el diccionario.')
    diccionario[clave] = 'Ninguno'
    
usuarios2 = {'001': 'Mark', '002': 'Monica', '003': 'Jacob'}
 
validar_clave(usuarios2, id_usuario)
print(usuarios2)
